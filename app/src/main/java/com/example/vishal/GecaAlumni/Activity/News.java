...
import com.example.vishal.GecaAlumni.Adapter.NewJobAdapter;
...
public class News extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycle_newJob);
        ...
        newJobAdapter = new NewJobAdapter(News.this,arrlist);
...
*/
                if(response != null){
                    ...
                    Toast.makeText(News.this,"Please Wait",Toast.LENGTH_LONG);
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                Toast.makeText(News.this,"Failed",Toast.LENGTH_LONG);
            }
        });
