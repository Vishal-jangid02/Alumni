...
import com.example.vishal.GecaAlumni.Manifest;
...
/*
        if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(getApplicationContext(), new String[]{Manifest.permission.READ_SMS, Manifest.permission.}, 101);
*/
        ...
        findViewById(R.id.buttonBuy).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* Intent i = new Intent(getApplicationContext(), checksum.class);
                startActivity(i);*/
            }
        });
...
//implementing PaytmPaymentTransactionCallback to track the payment result.
public class Donates extends AppCompatActivity implements PaytmPaymentTransactionCallback {

    EditText donateMoney;
    Button btn_Money;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donateMoney = (EditText) findViewById(R.id.donateMoney);
    ...
    private void generateCheckSum() {
        ...
        String txnAmount = donateMoney.getText().toString().trim();
